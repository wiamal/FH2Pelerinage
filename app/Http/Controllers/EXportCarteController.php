...
class EXportCarteController extends Controller
{
    //
    ...
    public function export(Request $request){
        ...
        // get data from database view Adherent
        // get data from database view Conjooint
        // get data from database view Enfant
        ...
        // Prepare columns names 
                ...
                for ($i=0 ; $i<count($vueadherent);$i++){

                    $keys = array_keys($vueadherent);

                    foreach($vueadherent[$keys[$i]] as $key => $value) {
                        $dataAdherentRow[$key] = $value ;    
                    }
                ...
                for ($i=0 ; $i<count($vueconjoint);$i++){

                    $keys = array_keys($vueconjoint);

                    foreach($vueconjoint[$keys[$i]] as $key => $value) {
                        $dataConjointRow[$key] = $value ;    
                    }
                ...
                for ($i=0 ; $i<count($vueenfant);$i++){

                    $keys = array_keys($vueenfant);

                    foreach($vueenfant[$keys[$i]] as $key => $value) {
                        $dataEnfantRow[$key] = $value ;    
                    }
