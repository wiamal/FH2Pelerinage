...
class inscriptionPelerinageController extends Controller
{
    public function fonctionnaire()
    {
        ...
        if ($idAdherent) {
            ...
            if ($adherent->PPR) {
                $fonction = true;
                return view('dashboard.pelerinage.inscriptionPelerinage', compact('fonction', 'adherent', 'pelerinage'));
            } else {
                $errorMessage = 'Veuillez regler votre situation administratif';
                return view('dashboard.pelerinage.inscriptionPelerinage', compact('errorMessage', 'adherent', 'pelerinage'));
            }
        }
    }
    ...
    public function retraite()
    {
        ...
        if ($adherent->Pension_Retraite != null) {
            $retraite = true;
            return view('dashboard.pelerinage.inscriptionPelerinage', compact('retraite', 'adherent', 'pelerinage'));
        } else {
            $errorMessage = "Vous n'avez pas informer la fondation de votre départ à la retraite. Merci de vous présentez à la fondation
