...
@section('content')
    <div class="container text-guide d-flex justify-content-center">
        <div class="">
            ...
            <div class="p-2 mb-3">
                <p class="text-center">Suivez les étapes suivantes pour réinitialiser votre mot de passe :</p>
                <ol>
                    <li>Entrez votre adresse e-mail ;</li>
                    <li>Vos informations de récupération vous seront envoyées par e-mail ;</li>
                    <li>Suivez les instructions afin de pouvoir à nouveau accéder à votre compte <strong>Espace
                            Adhérent</strong>.</li>
                </ol>
            </div>
