<div class="panel" id='accueilPanel'>
    ...
    <div class="card my-4">
        <div class="card-header">
            <h2 class="programmeAidePelerinage">Bienvenue au programme d'aide au Pèlerinage !</h2>
        </div>
        <div class="card-body">
            ...
            <ul>
                ...
                <li>
                    Il ne doit pas avoir déjà bénéficié d'une aide financière, d'un billet de voyage, d'une indemnité ou
                    d'une
                    subvention similaire provenant du budget des administrations publiques, des institutions publiques,
                    des
                    institutions ou des associations sociales, ou de toute autre institution ou association bénéficiant
                    du
            ...
            <div class="col-12  p-2"> Pour participer, veuillez remplir le formulaire d'inscription disponible sur notre
                site.
        ...
        <div class="card-footer bg-light">
            ...
            <div class="col"><a href="{{ route('livewire.pelerinage.inscription') }}"
                    class="inscriptionbutton">Inscription pour les
                    fonctionaires</a></div>
        </div> --}}
        </div>
    </div>
