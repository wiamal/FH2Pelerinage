<aside class="control-sidebar control-sidebar-light">
  ...
  <ul class="list-group bg-dark mb-3">
      <li class="list-group-item">
        <a href="{{ route('dashboard.profil.Password') }}" class="d-flex align-items-center "><i class="fa fa-lock pr-2"></i><b >Mot de passe</b> </a>
      </li>
      <li class="list-group-item">
        <a href="{{ route('dashboard.profil') }}" class="d-flex align-items-center"><i class="fa fa-user pr-2"></i><b >Mon profile</b> </a>
      </li>
  </ul>
